...
function LocaleChange() {
  ...
  return (
    <div className="flex flex-row h-7 w-32 items-center rounded-br-full rounded-bl-full border border-gray-200 rounded-xl p-3 dark:bg-yellow-500 bg-gray-500">
      <ReactCountryFlag
        countryCode="US"
        svg
